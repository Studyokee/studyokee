(function() {
  define(['backbone', 'handlebars', 'templates'], function(Backbone, Handlebars) {
    ...
    VocabularyMetricsView = Backbone.View.extend({
      ...
      render: function() {
        var currentCount, currentLevel, i, levels, nextLevel, percentDone, renderModel, withUnknown, _i, _ref;
        levels = [
          {
            label: 'Novice',
            count: 0
        ...
        for (i = _i = 1, _ref = levels.length - 1; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
          nextLevel = levels[i];
...
/*
//@ sourceMappingURL=vocabulary-metrics-view.js.map
*/