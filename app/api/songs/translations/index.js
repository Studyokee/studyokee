...
app.get('/translations/:artist/:title/:language', function (req, res) {
...
app.get('rdio/:rdioKey/translations/:language', function (req, res) {
    assert(req.hasOwnProperty('song'));
...
app.put('rdio/:rdioKey/translations/:language', function (req, res) {
